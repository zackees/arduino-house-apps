// Zach Vorhies:
// This TCL class is the "TotalControlLighting" driver which controls the underlying
// drawing of lights. This is used by the LedRopeTCL for drawing.
...
class TclClass {
  public:
    ...
    static void setNewLedChipset(bool val);
  private:
    static bool use_new_led_chipset;
#ifdef TCL_DIO
